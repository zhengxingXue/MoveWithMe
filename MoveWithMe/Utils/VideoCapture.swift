...
class VideoCapture: NSObject {
    ...
    private func setCaptureSessionOutput() throws {
        ...
        if let connection = videoOutput.connection(with: .video),
            ...
            AVCaptureVideoOrientation(deviceOrientation: UIDevice.current.localizedModel == "iPad" ? UIDevice.current.orientation : .portrait)
//            print("DEBUG: videoOrientation = \(connection.videoOrientation)")
